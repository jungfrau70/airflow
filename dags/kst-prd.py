...
t2 = BashOperator(
    task_id=f"auto-kisStock-trader",
    # bash_command=f"echo 'bashOperator'; sleep 300",
    bash_command=f"docker run -v /home/ian/work/invest-to-bitcoin/app/trade.log:/app/trade.log docker run -e TZ=Europe/Amsterdam debian:jessie date; sleep 300",
    dag=dag
)
